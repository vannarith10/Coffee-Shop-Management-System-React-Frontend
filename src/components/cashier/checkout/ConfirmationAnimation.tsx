...
const ConfirmationAnimation: React.FC = () => {
    ...
    <div className="loader">
      <span style={{ "--d": "100ms" } as React.CSSProperties}>w</span>
      <span style={{ "--d": "250ms" } as React.CSSProperties}>a</span>
      <span style={{ "--d": "400ms" } as React.CSSProperties}>i</span>
      <span style={{ "--d": "550ms" } as React.CSSProperties}>t</span>
